...
def main():
    ...
    my_cascade = haarCascade(r"C:\Users\Ajay Bhat\OneDrive\Desktop\deepgaze-master\etc\xml\haarcascade_frontalface_alt.xml", r"C:\Users\Ajay Bhat\OneDrive\Desktop\deepgaze-master\etc\xml\haarcascade_profileface.xml")
    #TODO If missing, example file can be retrieved from http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
    my_detector = faceLandmarkDetection(r'C:\Users\Ajay Bhat\OneDrive\Desktop\deepgaze-master\etc\xml\shape_predictor_68_face_landmarks.dat')
